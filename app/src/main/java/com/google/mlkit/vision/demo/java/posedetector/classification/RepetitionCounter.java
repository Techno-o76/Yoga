...
public class RepetitionCounter {
  ...
  public RepetitionCounter(String className, float enterThreshold, float exitThreshold) {
    if(className.equals("chair")){
      this.className = "chair_pose";
    }
    else if(className.equals("warrior_1")){
      this.className = "warrior-1";
    }
    else if(className.equals("warrior_2")){
      this.className = "warrior";
    }
    else if(className.equals("warrior_3")){
      this.className = "warrior-3";
    }
    else this.className = "tree";
